    ...
    >
      ...
      <div class="el-radio-group">
        <template v-for="(opt, index) in getOptions || []">
          <div :key="index"   v-if="opt.pic&&opt.picUrl"
            :class="config.option.column>index?'t-inline pic-box':''">
            <div class="radio-box ">
          ...
          <div  v-else :key="index" :class="config.option.column>index?'t-inline pic-box':''">
            <el-radio class="radio-item" v-model="radio"
              :label="opt.value">
              {{opt.label}}
            </el-radio>
