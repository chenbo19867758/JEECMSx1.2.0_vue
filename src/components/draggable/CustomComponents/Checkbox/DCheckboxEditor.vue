<template>
  <base-form
    class="d-checkbox-editor-container z-draggable-editor"
    ref="baseForm"
    ...
    <template #options="scope">
      <div class="option-wrap">
        ...
        <div class="other-option-wrap">
          <el-checkbox v-model="scope.form.isOtherOption" class="z-checkbox-single sm-height">添加其他选项</el-checkbox>
          <transition name="fade">
            <div v-if="scope.form.isOtherOption" class="other-option">
              ...
              <el-checkbox v-model="scope.form.isOtherOptionRequired" class="z-checkbox-single">此项必填</el-checkbox>
            </div>
          </transition>
        </div>
      </div>
