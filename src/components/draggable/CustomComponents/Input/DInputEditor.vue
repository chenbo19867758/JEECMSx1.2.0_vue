  ...
  >
    <template #rules="scope">
      <div class="rules-wrap">
        <div class="rule-item">
          <el-checkbox v-model="scope.form.isLengthLimit" class="z-checkbox-single">限制字数</el-checkbox>
        ...
        <div class="rule-item" :class="{'is-length-limit': scope.form.isLengthLimit}">
          ...
          <el-checkbox @change="handleChangeInputLimit" v-model="scope.form.isInputLimit" class="z-checkbox-single">输入限制</el-checkbox>
