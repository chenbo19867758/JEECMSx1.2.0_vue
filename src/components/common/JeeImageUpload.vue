<template>
  <section class="jee-image-upload-container">
        ...
        <div class="img-editor-wrap">
          ...
          <div class="editor jee-hover-border-important">
            <el-tooltip content="重新上传" placement="bottom" effect="light">
              <jee-icon iconClass="chongxinshangchuan" class="jee-hover-fill" @click="reUpload"/>
            </el-tooltip>
    ...
    custom-class="transparent"
      ...
      append-to-body :width="(imageStyle.w+60)+'px'">
    ...
    <!-- 裁剪 -->
    <el-dialog class="cropper-dialog" title="图片裁剪" :visible.sync="dialogVisible2" append-to-body>
  ...
  methods: {
    ...
    handleSubmit () {
      this.$refs.cropper.getCropBlob((data) => {
        let files = new File([data], this.file.fileName, { type: 'image/png', lastModified: Date.now() })
