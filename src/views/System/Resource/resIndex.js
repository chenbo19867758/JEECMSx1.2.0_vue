  ...
  methods: {
    ...
    showResourceMenus (item, i, e) {
      ...
      if (this.activeName === 'myRes' && item.shareStatus === 2) {
        ...
        this.menuItemList.myRes[2].disabled = !this._checkPermission('/admin/resourceSpaceDatas/unShare', 'POST')
      } else {
        this.menuItemList.myRes[2].text = '共享'
        this.menuItemList.myRes[2].disabled = !this._checkPermission('/admin/resourceSpaceDatas/share', 'POST')
      }
    },
    resourceClick (data) {
