          ...
          <ul class="resource-list-wrap">
            <el-checkbox-group v-model="list.selectedKeys">
              <li class="resource-list-item"
                ...
                <div class="resource-list-edit" v-if="renames[activeName][item.id]">
        ...
        'myRes': [
          {
            ...
            name: '共享',
            icon: 'gongxiang',
            disabled: !this._checkPermission('/admin/resourceSpaceDatas/share', 'POST')
          },
          {
            type: 'UnShare',
            name: '取消共享',
            icon: 'quxiaogongxiang',
            disabled: !this._checkPermission('/admin/resourceSpaceDatas/unShare', 'POST')
          },
          {
            type: 'Move',
            name: '移动',
            icon: 'yidong',
            disabled: !this._checkPermission('/admin/resourceSpaceDatas/shift', 'PUT')
          },
          {
            type: 'Upload',
            name: '上传',
            icon: 'shangchuan',
            disabled: !this._checkPermission('/admin/upload/o_upload', 'POST')
          },
          {
            type: 'Config',
            name: '共享设置',
          ...
          },
          {
            ...
            name: '批量下载',
            icon: 'piliangxiazai',
            disabled: !this._checkPermission('/admin/resourceSpaceDatas/download', 'POST')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/admin/resourceSpaceDatas', 'DELETE')
          }
        ],
        'shareRes': [
          {
        ...
        'myRes': [// 菜单
          {
            key: '1',
            text: '重命名',
            disabled: !this._checkPermission('/admin/resourceSpaceDatas', 'PUT')
          },
          {
            key: '2',
            text: '移动',
