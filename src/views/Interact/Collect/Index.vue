      ...
      <el-aside width="190px">
        <div class="interact-collect-index-tree">
          <div class="interact-collect-index-tree-top">
            <el-button :disabled="!_checkPermission('/interact/collect/detail', 'GET')" type="primary" size="small" @click="addCollect"><jee-icon iconClass="xinjian"></jee-icon>新建任务</el-button>
          </div>
        ...
        buttons: [
          {
            ...
            icon: 'liulan',
            prim: true,
            disabled: !this._checkPermission('/interact/collect/detail?collectType=See', 'GET'),
            isHidden: false
          },
          {
            type: 'Edit',
            ...
            icon: 'xiugaihuifu',
            isHidden: false,
            disabled: !this._checkPermission('/interact/collect/detail?collectType=Edit', 'GET'),
            iconStyle: {
              fontSize: '14px'
            }
          },
          ...
          },
          {
            ...
            icon: 'yidong1',
            isHidden: false,
            disabled: !this._checkPermission('/admin/collect/consumeByIds', 'POST')
          },
          {
            type: 'DeleteData',
            text: '删除数据',
        ...
        if (item.disabled === false) {
          ...
          if (this.isDisabled) {
            ...
            if (item.type === 'Start') {
              ...
              item.disabled = !this._checkPermission('/admin/collect/consumeByIds', 'POST')
            }
          }
        }
      })
