      ...
      searchHeader: {
        searchBtns: [
          ...
          },
          {
            ...
            type: 'DeleteChannl',
            name: '彻底删除栏目',
            disabled: !this._checkPermission('/admin/channel/thorough', 'DELETE')
          },
          {
            icon: 'huanyuan',
            type: 'ReductionChannl',
            name: '还原栏目',
            disabled: !this._checkPermission('/admin/channel/reduction', 'PUT')
          },
          {
            icon: 'delete',
            type: 'Empty',
      ...
      switch (data.type) {
        case 'DeleteCont':
          if (ids.length > 0) {
            ...
            this.msgChange('彻底删除后不可恢复，确定彻底删除所选内容？', () => {
