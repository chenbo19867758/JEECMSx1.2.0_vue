    ...
    <table-dialog
      ...
      <template #detail="scope">
        <div class="cd-wrap">
          ...
          <div class="cd-cont" v-html="scope.form.jsonTxt.content"></div>
        </div>
      </template>
    </form-dialog>
          ...
          searchBtns: [
            {
              ...
              type: 'Save',
              name: '保存当前版本',
              disabled: !this._checkPermission('/admin/contentVersion', 'POST')
            },
            {
              icon: 'ic_restore_page_px',
              type: 'Recovery',
              name: '恢复此版本',
              disabled: !this._checkPermission('/admin/contentVersion/recovery', 'PUT')
            },
            {
              icon: 'banbenduibi',
              type: 'Contrast',
              name: '与当前版本对比',
              disabled: !this._checkPermission('/admin/contentVersion/compare', 'POST')
            },
            {
              icon: 'banbenduibi',
              type: 'ContrastSel',
            ...
            },
            {
              ...
              type: 'Delete',
              name: '删除版本',
              disabled: !this._checkPermission('/admin/contentVersion', 'DELETE')
            }
          ]
        },
        data: [],
