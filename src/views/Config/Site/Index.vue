        ...
        handleColumn: [
          {
            ...
            name: 'global.create',
            icon: 'xinjian',
            disabled: !this._checkPermission('/admin/sites', 'POST')
          },
          {
            type: 'Link',
            name: '预览',
          ...
          },
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/admin/sites', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            icon: 'huishouzhan',
            disabled: !this._checkPermission('/admin/sites/recycle', 'GET')
          }
        ],
        title: '',
        showAlertIcon: false
