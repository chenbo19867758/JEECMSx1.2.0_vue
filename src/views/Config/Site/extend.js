...
export default {
      ...
      expandForm: {
        ...
        formItems: [
          ...
          },
          {
            ...
            label: '新内容标志：',
            type: 'imageUpload',
            urlProp: 'contentNewFlagDefinitionUrl',
            option: {
              isSingleImage: true,
        ...
        rules: {
          newContentResourceId: [this.$rules.required()],
          ...
          contentNewFlagDefinition: [this.$rules.required()],
  ...
  methods: {
    ...
    handleConfirmExpand (data) {
      ...
      obj.cfg.newContentResourceId = data.newContentResourceId
