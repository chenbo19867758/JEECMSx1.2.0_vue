  ...
  <section class="security-index-container">
    ...
    <template #cronName="scope">
      <el-link :underline="false" class="cron-name-link jee-color" type="primary"  @click="rowHref(scope.scope.row)"
        :disabled="!_checkPermission('/admin/jobs', 'PUT')"
  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'switch',
        type: 'Status',
        disabled: !this._checkPermission('/admin/jobs/enabledJobs', 'POST') || !this._checkPermission('/admin/jobs/disabledJobs', 'POST')
      }
    ]
    return {
      list: {
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/admin/jobs', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/admin/jobs', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
