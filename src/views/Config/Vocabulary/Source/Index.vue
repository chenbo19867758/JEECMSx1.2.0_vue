  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/admin/sysSource', 'PUT')
      },
      {
        prop: 'sourceLink',
        label: '来源链接',
        ...
        handleColumn: [
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/admin/sysSource', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/admin/sysSource', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
