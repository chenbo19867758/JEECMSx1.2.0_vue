  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/admin/sensitiveWords', 'PUT')
      },
      {
        prop: 'replaceWord',
        label: '替换词'
        ...
        handleColumn: [
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/admin/sensitiveWords', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/admin/sensitiveWords', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
          ...
          },
          {
            ...
            disabled: !this._checkPermission('/admin/sensitiveWords/import', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false
