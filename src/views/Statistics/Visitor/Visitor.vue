...
export default {
  ...
  data () {
    return {
      ...
      height: 400,
      visitorObj: Object.assign({}, visitorObj)
    }
  },
  computed: {
  ...
  methods: {
    ...
    setData (data) {
      ...
      // that.websiteList.data = data
      if (data instanceof Array && data.length) {
        data.forEach(d => {
          const k = d.isNew ? 'new' : 'old'
      ...
      this.visitorObj.oldRate = totalUv ? this.visitorObj.oldUv * 10 / totalUv : 0
    },
    // 今日
