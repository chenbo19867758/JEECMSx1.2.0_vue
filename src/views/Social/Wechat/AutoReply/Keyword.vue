        ...
        buttons: [
          {
            ...
            text: '添加回复',
            icon: 'xinjian',
            disabled: !this._checkPermission('/admin/keyWord', 'POST')
          }
        ],
        showAlertIcon: false
      },
        ...
        handleColumn: [
          {
            ...
            name: '编辑',
            icon: 'bianji',
            disabled: !this._checkPermission('/admin/wechatreplycontent', 'PUT')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'tangchuangguanbi',
            disabled: !this._checkPermission('/admin/wechatreplycontent', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
