                ...
                <div class="send-box__comment" v-if="getData[data.day]">
                  ...
                  <div class="send-box__btns" v-if="!dateFilter(data.day)">
                    <el-link
                      ...
                      :disabled="!_checkPermission('/admin/wechatsend', 'PUT')"
                    >
                    ...
                    <el-link
                      ...
                      :disabled="!_checkPermission('/admin/wechatsend', 'DELETE')"
                    >
  ...
  methods: {
    ...
    sendCalendar (data, item) {
      ...
      if (!status) {
        ...
        const addPerm = this._checkPermission('/admin/wechatsend', 'POST')
        const editPerm = this._checkPermission('/admin/wechatsend', 'PUT')
