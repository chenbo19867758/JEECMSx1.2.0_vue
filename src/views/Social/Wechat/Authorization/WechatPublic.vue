        ...
        <div class="resource-wrap">
          ...
          <div class="resource-name">
            <el-link :underline='false' type='primary' class="jee-color"
              ...
              :disabled="!_checkPermission('/admin/wechatInfo', 'GET')"
        ...
        buttons: [
          {
            ...
            disabled: !this._checkPermission('/weChat/grantAuth', 'GET')
          }
        ],
        showAlertIcon: false
      },
        ...
        handleColumn: [
          {
            ...
            name: '取消授权',
            icon: 'quxiaoshouquan',
            disabled: !this._checkPermission('/admin/wechatInfo', 'DELETE')
          },
          {
          ...
          },
          {
            ...
            name: '设置管理员',
            icon: 'guanliyuan',
            disabled: !this._checkPermission('/admin/wechatInfo/coreUser', 'POST')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
