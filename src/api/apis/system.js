...
export default {
  ...
  fetchSysSecretDelete (ids) {
    return axios.delete(systemUrls.sysSecrets, { ids })
  },
  ...
  fetchSysUsersDataPermUpdate (data) {
    return axios.put(systemUrls.sysUsersDataPerm, data)
  },
  // 用户名验证
  ...
  // 获取短信服务配置
  fetchSmsDetail (data) {
    return axios.get(systemUrls.sms, data)
  },
  // 修改短信服务配置
  fetchSmsUpdate (data) {
    return axios.post(systemUrls.sms, data)
  },
  // 资源空间-我的资源列表
